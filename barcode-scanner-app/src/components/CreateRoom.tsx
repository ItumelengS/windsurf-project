...
export const CreateRoom = ({ onSave, onClose }: CreateRoomProps) => {
  const [roomName, setRoomName] = useState('');
  const [roomBarcode, setRoomBarcode] = useState('');
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full p-6 my-8">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl font-bold text-gray-800">Create New Room</h2>
          <button
            onClick={onClose}
        ...
        <div className="mb-6">
          ...
          {showEquipmentForm && (
            <div className="bg-blue-50 p-4 rounded-lg mb-4 border-2 border-blue-200">
              <h4 className="font-semibold text-gray-800 mb-3">New Equipment</h4>
